...
def main() -> None:
    ...
    #model: Model = Model(constants.CELL_COUNT, constants.CELL_SPEED, constants.VULNERABLE, constants.INFECTED)
    model: Model = Model(constants.CELL_COUNT, constants.CELL_SPEED, constants.INFECTED, constants.IMMUNE_CELLS)
